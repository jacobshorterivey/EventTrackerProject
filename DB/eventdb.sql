...
INSERT INTO `game` (`id`, `name`, `description`, `developer`, `platform`, `release_date`, `completed`, `hours_to_complete`, `img_url`, `genre`) VALUES (7, 'Fire Emblem: Shadow Dragon', 'https://upload.wikimedia.org/wikipedia/en/9/9b/Fire_Emblem_DS.jpg', 'Intelligent Systems', 'Nintendo DS', '2009-02-16', 1, 26.7, 'https://upload.wikimedia.org/wikipedia/en/9/9b/Fire_Emblem_DS.jpg', 'tactical RPG');
